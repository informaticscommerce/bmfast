...
namespace Mage4\CustomB2BAttr\Controller\Account;
...
class CreatePost extends AbstractAccount implements CsrfAwareActionInterface, HttpPostActionInterface
{
    ...
    protected function extractAddress()
    {
        ...
        if($this->getRequest()->getParam('company_email')) {
            $addressData['company_email'] = $this->getRequest()->getParam('company_email');
        }
        if($this->getRequest()->getParam('ein_id')) {
            $addressData['ein_id'] = $this->getRequest()->getParam('ein_id');
        }
        if($this->getRequest()->getParam('reseller_id')) {
            $addressData['reseller_id'] = $this->getRequest()->getParam('reseller_id');
        }
        if($this->getRequest()->getParam('job_position')) {
            $addressData['job_position'] = $this->getRequest()->getParam('job_position');
        }
