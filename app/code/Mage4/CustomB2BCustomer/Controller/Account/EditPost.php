...
class EditPost extends AbstractAccount implements CsrfAwareActionInterface, HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        if ($validFormKey && $this->getRequest()->isPost()) {
            ...
            $customerCandidateDataObject->setCustomAttribute('company_email',$this->getRequest()->getParam('company_email'));
            $customerCandidateDataObject->setCustomAttribute('ein_id',$this->getRequest()->getParam('ein_id'));
            $customerCandidateDataObject->setCustomAttribute('reseller_id',$this->getRequest()->getParam('reseller_id'));
            $customerCandidateDataObject->setCustomAttribute('job_position',$this->getRequest()->getParam('job_position'));
