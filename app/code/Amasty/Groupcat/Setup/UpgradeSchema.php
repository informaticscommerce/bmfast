...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    /**
     * @var Operation\UpgradeTo158
     */
    private $upgradeTo158;

    public function __construct(Operation\UpgradeTo158 $upgradeTo158)
    {
        $this->upgradeTo158 = $upgradeTo158;
    }
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        /** @since 1.5.8 removed columns stock_status, price_range_enabled, by_price, from_price, to_price */
        if (version_compare($context->getVersion(), '1.5.8', '<')) {
            $this->upgradeTo158->execute($setup);
        }
