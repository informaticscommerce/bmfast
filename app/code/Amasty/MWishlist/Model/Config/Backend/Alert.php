...
{
    const CRON_STRING_PATH = 'crontab/default/jobs/amasty_mwishlist_notify_customer/schedule/cron_expr';
    const CRON_MODEL_PATH = 'crontab/default/jobs/amasty_mwishlist_notify_customer/run/model';
