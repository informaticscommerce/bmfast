...
class ConfigProvider extends \Amasty\Base\Model\ConfigProviderAbstract implements CollectionDataSourceInterface
{
    ...
    const GENERAL_URL_KEY = 'general/url_key';
    ...
    const CUSTOMER_NOTIF_CREDIT_CHANGED = 'customer_notif/store_credit_changed';
    const CUSTOMER_NOTIF_OVERDRAFT_CHANGED = 'customer_notif/overdraft_config_changed';
    const CUSTOMER_NOTIF_OVERDRAFT_USED = 'customer_notif/overdraft_used';
    const CUSTOMER_NOTIF_OVERDRAFT_PENALTY = 'customer_notif/overdraft_penalty_applied';
