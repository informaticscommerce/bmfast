...
{
    const MAIN_TABLE = 'amasty_company_credit';

    const ID = 'id';
    const COMPANY_ID = 'company_id';
    const BALANCE = 'balance';
    const ISSUED_CREDIT = 'credit';
    const BE_PAID = 'be_paid';
    const CURRENCY_CODE = 'currency_code';
    const ALLOW_OVERDRAFT = 'allow_overdraft';
    const OVERDRAFT_LIMIT = 'overdraft_limit';
    const OVERDRAFT_REPAY_PERIOD = 'overdraft_repay_period';
    const OVERDRAFT_REPAY_DIGIT = 'overdraft_repay_digit';
    const OVERDRAFT_REPAY_TYPE = 'overdraft_repay_type';
    const OVERDRAFT_PENALTY = 'overdraft_penalty';
